...
<body id="main" class="<?php echo $body_class ?>">
    <div id="page-wrapper">
        ...
        <div id="main-content">
            ...
            <div id="sidedrawer-page-modal" class="modal right fade" role="dialog">
            ...
            <template id="loading-indicator">
                <div class="p-2 text-center d-flex justify-content-center">
                    ...
                    <span class="font-weight-light">Loading...</span>
                </div>
            </template>
        </div>
        <div id="app-toast-success" style="display: none;"
            class="toast-alert row bg-success text-white alert animated bounce fixed-alert">
            <div><i class="material-icons">check_circle</i></div>
            <div class="msg">Message here</div>
        </div>
        <div id="app-toast-danger" style="display: none;"
            class="toast-alert row alert bg-danger text-white animated shake fixed-alert">
