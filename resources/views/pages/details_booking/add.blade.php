...
<?php
    $pageTitle = "Add New Details Booking";
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="details_booking-add-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="{{ route('details_booking.store') }}" method="post" >
                            @csrf
                            <div>
