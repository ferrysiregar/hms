...
<?php
    $pageTitle = "Additional Charge Details";
?>
@extends($layout)
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-tax_charge p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> Tax Charge</div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <div class="border-top td-service_charge p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                        ...
                                        <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("additional_charge/delete/$rec_id"); ?>">
