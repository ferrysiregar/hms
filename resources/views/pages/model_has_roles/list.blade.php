                                ...
                                <div id="page-main-content" class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <!--PageComponentEnd-->
                                            <td class="td-btn">
                                                <a class="mx-1 btn btn-sm btn-primary has-tooltip "   title="Lihat" href="<?php print_link("model_has_roles/view/$rec_id"); ?>">
                                                <i class="material-icons">visibility</i> View
                                            </a>
                                            <a class="mx-1 btn btn-sm btn-success has-tooltip "   title="Ubah" href="<?php print_link("model_has_roles/edit/$rec_id"); ?>">
                                            <i class="material-icons">edit</i> Edit
                                        </a>
                                        <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Hapus" href="<?php print_link("model_has_roles/delete/$rec_id"); ?>">
