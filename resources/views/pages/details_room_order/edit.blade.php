...
<?php
    $pageTitle = "Edit Details Room Order";
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("details_room_order/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-product_name-holder" class=" ">
                                                    <select required=""  id="ctrl-product_name" data-load-select-options="price" name="product_name"  placeholder="Select a value ..."    class="custom-select" >
                                                    <option value="">Select a value ...</option>
                                                    <?php
                                                        $options = $comp_model->details_room_order_product_name_option_list() ?? [];
                                                        foreach($options as $option){
                                                        $value = $option->value;
                                                        $label = $option->label ?? $value;
                                                        $selected = ( $value == $data['product_name'] ? 'selected' : null );
                                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-price-holder" class=" ">
                                                    ...
                                                    <?php
                                                        $options = $comp_model->details_room_order_price_option_list($data['product_name']) ?? [];
                                                        foreach($options as $option){
                                                        $value = $option->value;
                                                        $label = $option->label ?? $value;
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-notes-holder" class=" ">
                                                    <textarea placeholder="Enter Notes" id="ctrl-notes"  rows="5" name="notes" class=" form-control"><?php  echo $data['notes']; ?></textarea>
