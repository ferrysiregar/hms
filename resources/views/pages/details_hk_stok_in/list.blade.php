        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="col-md-auto " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("details_hk_stok_in/add") ?>" >
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid" >
                ...
                <div  class=" page-content" >
                    <div id="details_hk_stok_in-list-records">
                        <div class="row">
                            <div class="col">
                                <div id="page-main-content" class="table-responsive">
                                    ...
                                    <?php Html::page_bread_crumb("/details_hk_stok_in/", $field_name, $field_value); ?>
