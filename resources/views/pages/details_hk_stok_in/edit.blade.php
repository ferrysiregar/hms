...
<?php
    $pageTitle = "Edit Details Hk Stok In";
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("details_hk_stok_in/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
