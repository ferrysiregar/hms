                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-user_name p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                        ...
                                        <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("users/delete/$rec_id"); ?>">
