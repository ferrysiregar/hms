...
<?php
    $pageTitle = "Role Has Permissions Details";
?>
@extends($layout)
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class="">
                            <div class="row">
                                ...
                                <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("role_has_permissions/delete/$rec_id"); ?>">
