            ...
            <div class="row ">
                <div class="col-md-12 comp-grid" >
                    ...
                    <div  class=" page-content" >
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("permissions/delete/$rec_id"); ?>">
                        ...
                        <div class="col-12">
                            <div class="my-3 ">
                                @include("pages.permissions.detail-pages", ["masterRecordId" => $rec_id])
                            </div>
                        </div>
                        <?php } ?>
                    </div>
