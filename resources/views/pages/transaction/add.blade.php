            ...
            <div class="row ">
                <div class="col-sm-12 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="transaction-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('transaction.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-customers_id-holder" class=" ">
                                                ...
                                                <?php 
                                                    $options = $comp_model->transaction_customers_id_option_list() ?? [];
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-agent_id-holder" class=" ">
                                                ...
                                                <option value="">Select a value ...</option>
                                                <?php 
                                                    $options = $comp_model->transaction_agent_id_option_list() ?? [];
                                                    foreach($options as $option){
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-payment_status_id-holder" class=" ">
                                                <?php 
                                                    $options = $comp_model->transaction_payment_status_id_option_list() ?? [];
                                                    foreach($options as $option){
                                                    $value = $option->value;
                                                    $label = $option->label ?? $value;
                            ...
                            <div class="bg-light p-2 subform">
                                <h4 class="record-title">Add New Details Transaction</h4>
                                <hr />
                                @csrf
                                <div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="input-row">
                                                <td>
                                                    ...
                                                    <select required=""  id="ctrl-room_id-row<?php echo $row; ?>" data-load-select-options="price" name="details_transaction[<?php echo $row ?>][room_id]"  placeholder="Select a value ..."    class="custom-select" >
                                                    <option value="">Select a value ...</option>
                                                    <?php 
                                            ...
                                            <td>
                                                ...
                                                <select required=""  id="ctrl-price-row<?php echo $row; ?>" data-load-path="<?php print_link('componentsdata/price_option_list') ?>" name="details_transaction[<?php echo $row ?>][price]"  placeholder="Select a value ..."    class="custom-select" >
                                                <option value="">Select a value ...</option>
                                                </select>
                                            </div>
                                        </td>
                                    ...
                                    <td>
                                        ...
                                        <input id="ctrl-checkin_time-row<?php echo $row; ?>" class="form-control datepicker  datepicker"  required="" value="<?php echo get_value('checkin_time') ?>" type="time" name="details_transaction[<?php echo $row ?>][checkin_time]" placeholder="Enter Checkin Time" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                        <div class="input-group-append">
                            ...
                            <td>
                                ...
                                <input id="ctrl-checkout_time-row<?php echo $row; ?>" class="form-control datepicker  datepicker"  required="" value="<?php echo get_value('checkout_time') ?>" type="time" name="details_transaction[<?php echo $row ?>][checkout_time]" placeholder="Enter Checkout Time" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="material-icons">access_time</i></span>
                                </div>
                            </div>
                        ...
                        <td>
                            ...
                            <input id="ctrl-totals-row<?php echo $row; ?>"  value="<?php echo get_value('totals') ?>" type="number" placeholder="Enter Totals" step="0.1"  required="" name="details_transaction[<?php echo $row ?>][totals]"  class="form-control " />
                        </div>
                    </td>
