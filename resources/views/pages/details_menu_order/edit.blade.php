...
<?php
    $pageTitle = "Edit Details Menu Order";
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("details_menu_order/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-price-holder" class=" ">
                                                    ...
                                                    <?php
                                                        $options = $comp_model->details_menu_order_price_option_list($data['product_name']) ?? [];
                                                        foreach($options as $option){
                                                        $value = $option->value;
                                                        $label = $option->label ?? $value;
