...
<?php
    $pageTitle = "Edit Detils Purchase Order";
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <div class="row">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("detils_purchase_order/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-items_name-holder" class=" ">
                                                    ...
                                                    <?php
                                                        ...
                                                        $selected = ( $value == $data['items_name'] ? 'selected' : null );
                                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-units-holder" class=" ">
                                                    ...
                                                    <?php
                                                        $options = $comp_model->units_option_list($data['items_name']) ?? [];
                                                        foreach($options as $option){
                                                        $value = $option->value;
                                                        $label = $option->label ?? $value;
                                                        $selected = ( $value == $data['units'] ? 'selected' : null );
                                                    ?>
                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                    <?php echo $label; ?>
                                                    </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-price-holder" class=" ">
                                                    <input id="ctrl-price"  value="<?php  echo $data['price']; ?>" type="number" placeholder="Enter Price" step="any"  required="" name="price"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-qty-holder" class=" ">
                                                    <input id="ctrl-qty"  value="<?php  echo $data['qty']; ?>" type="number" placeholder="Enter Qty" step="any"  required="" name="qty"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-total-holder" class=" ">
                                                    <input id="ctrl-total"  value="<?php  echo $data['total']; ?>" type="number" placeholder="Enter Total" step="any"  required="" name="total"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
