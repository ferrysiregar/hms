...
<?php
    $pageTitle = "Details Hk Stok Out Details";
?>
@extends($layout)
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="page-data">
                                        ...
                                        <div class="border-top td-code_dethk_stokout p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> Code Dethk Stokout</div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <div class="border-top td-desc_locations p-2">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="text-muted"> Desc Locations</div>
                                                    <div class="font-weight-bold">
                                        ...
                                        <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("details_hk_stok_out/delete/$rec_id"); ?>">
