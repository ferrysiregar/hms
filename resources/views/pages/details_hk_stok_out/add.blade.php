...
<?php
    $pageTitle = "Add New Details Hk Stok Out";
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="details_hk_stok_out-add-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="{{ route('details_hk_stok_out.store') }}" method="post" >
                            @csrf
                            <div>
                            ...
                            <td>
                                ...
                                <input id="ctrl-desc_locations-row<?php echo $row; ?>"  value="<?php echo get_value('desc_locations') ?>" type="text" placeholder="Enter Desc Locations"  name="row[<?php echo $row ?>][desc_locations]"  class="form-control " />
                            </div>
                        </td>
