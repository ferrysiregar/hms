            ...
            <div class="row ">
                <div class="col-md-9 comp-grid" >
                    ...
                    <div  class=" page-content" >
                        <!--[form-start]-->
                        <form id="hk_stok_out-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('hk_stok_out.store') }}" method="post">
                            @csrf
                            <div>
                            ...
                            <div class="bg-light p-2 subform">
                                <h4 class="record-title">Add New Details Hk Stok Out</h4>
                                <hr />
                                @csrf
                                <div>
                                    <table class="table table-striped table-sm" data-maxrow="10" data-minrow="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-light"><label for="desc_locations">Desc Locations</label></th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="input-row">
                                                <td>
                                                    ...
                                                    <select required=""  id="ctrl-item-row<?php echo $row; ?>" name="details_hk_stok_out[<?php echo $row ?>][item]"  placeholder="Select a value ..."    class="custom-select" >
                                            ...
                                            <td>
                                                ...
                                                <input id="ctrl-qty-row<?php echo $row; ?>"  value="<?php echo get_value('qty') ?>" type="number" placeholder="Enter Qty" step="0.1"  required="" name="details_hk_stok_out[<?php echo $row ?>][qty]"  class="form-control " />
                                            </div>
                                        </td>
                                        <td>
                                            <div id="ctrl-conditions-row<?php echo $row; ?>-holder" class=" ">
                                            <select required=""  id="ctrl-conditions-row<?php echo $row; ?>" name="details_hk_stok_out[<?php echo $row ?>][conditions]"  placeholder="Select a value ..."    class="custom-select" >
                                            <option value="">Select a value ...</option>
                                            <?php 
                                    ...
                                    <td>
                                        ...
                                        <select required=""  id="ctrl-locations-row<?php echo $row; ?>" name="details_hk_stok_out[<?php echo $row ?>][locations]"  placeholder="Select a value ..."    class="custom-select" >
                                        <option value="">Select a value ...</option>
                                        <?php 
                                ...
                                <td>
                                    <div id="ctrl-desc_locations-row<?php echo $row; ?>-holder" class=" ">
                                    <input id="ctrl-desc_locations-row<?php echo $row; ?>"  value="<?php echo get_value('desc_locations') ?>" type="text" placeholder="Enter Desc Locations"  name="details_hk_stok_out[<?php echo $row ?>][desc_locations]"  class="form-control " />
                                </div>
                            </td>
