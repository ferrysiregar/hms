...
<?php
    $pageTitle = "Model Has Permissions Details";
?>
@extends($layout)
                        ...
                        <div id="page-main-content" class="">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a class="mx-1 btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Yakin Mau Hapus ?...." data-display-style="modal" title="Ubah" href="<?php print_link("model_has_permissions/delete/$rec_id"); ?>">
