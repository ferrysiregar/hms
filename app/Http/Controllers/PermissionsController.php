...
class PermissionsController extends Controller
{
	...
	function masterDetail($rec_id = null){
		return View("pages.permissions.detail-pages", ["masterRecordId" => $rec_id]);
	}
	...
	function store(PermissionsAddRequest $request){
		...
		$rec_id = $record->id;
		return $this->redirect("permissions", "Tambah Data Berhasil");
	}
	...
	function edit(PermissionsEditRequest $request, $rec_id = null){
		...
		if ($request->isMethod('post')) {
			...
			return $this->redirect("permissions", "Ubah Data Berhasil");
		}
