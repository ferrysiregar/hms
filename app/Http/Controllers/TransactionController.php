...
class TransactionController extends Controller
{
	...
	function index(Request $request, $fieldname = null, $fieldvalue = null)
	{
		...
		$view = "pages.transaction.list-room";
		...
		return $this->renderView($view, compact('room_types'));
	}

	public function checkin(Room $room)
	{
		// dd($room->load('room_type'));
		$view = "pages.transaction.checkin";

		$room = $room->load('room_type');

		return $this->renderView($view, compact('room'));
	}
	...
	function store(TransactionAddRequest $request)
	{
		...
		$detailsTransactionValidator = validator()->make($detailsTransactionPostData, [
			"*.room_id" => "required",
			"*.price" => "required",
